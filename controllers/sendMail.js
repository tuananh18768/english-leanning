...
const sendEmail = (to, url, txt) => {
    ...
    const mailOptions = {
        ...
        to: to,
        subject: "Englist leanning",
        html: `
            <div style="max-width: 700px; margin:auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 110%;">
                <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to the English leanning.</h2>
                <p>Congratulations! English leaning
